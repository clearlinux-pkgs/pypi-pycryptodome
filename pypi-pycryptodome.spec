...
Source0  : https://files.pythonhosted.org/packages/b1/38/42a8855ff1bf568c61ca6557e2203f318fb7afeadaf2eb8ecfdbde107151/pycryptodome-3.19.1.tar.gz
...
%prep
%setup -q -n pycryptodome-3.19.1
cd %{_builddir}/pycryptodome-3.19.1
pushd ..
cp -a pycryptodome-3.19.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703779844
