...
Source0  : https://files.pythonhosted.org/packages/8e/a6/8452177684d5e906854776276ddd34eca30d1b1e15aa1ee9cefc289a33f5/pycryptodome-3.23.0.tar.gz
...
%prep
%setup -q -n pycryptodome-3.23.0
cd %{_builddir}/pycryptodome-3.23.0
pushd ..
cp -a pycryptodome-3.23.0 buildavx2
popd
pushd ..
cp -a pycryptodome-3.23.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747670113
