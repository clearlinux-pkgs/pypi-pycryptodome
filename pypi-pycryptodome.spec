...
Source0  : https://files.pythonhosted.org/packages/b9/ed/19223a0a0186b8a91ebbdd2852865839237a21c74f1fbc4b8d5b62965239/pycryptodome-3.20.0.tar.gz
...
%prep
%setup -q -n pycryptodome-3.20.0
cd %{_builddir}/pycryptodome-3.20.0
pushd ..
cp -a pycryptodome-3.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704902394
