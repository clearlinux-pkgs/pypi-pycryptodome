...
Source0  : https://files.pythonhosted.org/packages/0d/66/5e4a14e91ffeac819e6888037771286bc1b86869f25d74d60bc4a61d2c1e/pycryptodome-3.16.0.tar.gz
...
%prep
%setup -q -n pycryptodome-3.16.0
cd %{_builddir}/pycryptodome-3.16.0
pushd ..
cp -a pycryptodome-3.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669552223
