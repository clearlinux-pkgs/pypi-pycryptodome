...
Source0  : https://files.pythonhosted.org/packages/72/8e/9249abf44e184905b2f610ddb5dc8eccec7ab5e91109fc6df2be8647ae46/pycryptodome-3.13.0.tar.gz
...
%prep
%setup -q -n pycryptodome-3.13.0
cd %{_builddir}/pycryptodome-3.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643042942
...
cp %{_builddir}/pycryptodome-3.13.0/Doc/LEGAL/copy/LICENSE.python-2.2 %{buildroot}/usr/share/package-licenses/pypi-pycryptodome/e2e326a9a73b4a86d3aa275bb1b9797ab1f047b7
cp %{_builddir}/pycryptodome-3.13.0/LICENSE.rst %{buildroot}/usr/share/package-licenses/pypi-pycryptodome/2f38e6ee60a1176611d852cf7fce799b477cd6b6
